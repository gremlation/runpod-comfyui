...
# Install ComfyUI core requirements and pinned torch stack
WORKDIR /tmp/build
...
# Install comfy-cli for registry-based node installation
RUN python3.12 -m pip install --no-cache-dir comfy-cli
